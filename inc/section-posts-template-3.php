<?php 
	/* 
	** @package makzine
	** Homepage Category Posts Three
	*/

class Makzine_Category_Post_Section_Three extends WP_Widget {
	
	function __construct() {
		
		$options = array(
			'classname' => 'makzine-category-post-section-three',
			'description' => 'Makzine homepage Category Posts type three',
		);

		parent::__construct('makzine_category_post_section_three', 'Makzine Category Posts Three', $options);
	...
	public function widget($args, $instance) {
        ...
        $cat_post_section_three_args = array (
            'post_type'        => 'post',
            'posts_per_page'   => $posts_per_page,
	        'cat'              => $cat
        );

		$cat_post_section_three_query = new WP_Query($cat_post_section_three_args);

		echo $args['before_widget']; 

		?>
		
				<div class="category-section-three border-btm">
					...
					<div class="section-widget-content">
						...
						<div class="col-sm-12 sc-o-sm-post">
							...
							// large thumb
								...
								if( $cat_post_section_three_query->have_posts() ): 

									while ( $cat_post_section_three_query->have_posts() ): 

										$cat_post_section_three_query->the_post(); 
							...
							?>
								...
								<article class="cat-post col-sm-6 clearfix">
									...
									<?php if( has_post_thumbnail() ):
                          	 			...
                          	 			$url = wp_get_attachment_url( get_post_thumbnail_id($cat_post_section_three_query->ID) ); 
...
add_action('widgets_init', function() {
	register_widget('Makzine_Category_Post_Section_Three');
} );
